...
| 2026-07-26 | v1.1 | 交互细节优化：① 按钮 loading 态/全变体按压反馈/触屏 44px 命中区 ② 间距工具补全刻度并新增 stack 垂直节奏 ③ 表单校验反馈图标化+入场动画、label/aria 无障碍关联 ④ 响应式：标题流式缩放、容器分段内边距、抽屉式导航、弹窗小屏适配 ⑤ 动画：修复 mlShimmer/mlPulse 重名冲突、transition 精确化、新增 prefers-reduced-motion 降级 |

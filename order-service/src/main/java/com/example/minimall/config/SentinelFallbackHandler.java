...
public class SentinelFallbackHandler {
    ...
    /**
     * 下单限流兜底 — 匹配 createOrder(Long, Long, List, Long) 签名。
     */
    public static Result<?> createOrderBlocked(Long userId, Long addressId,
            java.util.List<java.util.Map<String, Object>> items, Long userCouponId,
     ...
     * 下单业务异常兜底。
     */
    public static Result<?> createOrderFallback(Long userId, Long addressId,
            java.util.List<java.util.Map<String, Object>> items, Long userCouponId, Throwable ex) {
